...
- É importante observar que os Investimentos Públicos em Educação podem não levar, necessariamente, a uma melhoria esperada nos resultados em razão de:
  ...
  - fiscalização pouco efetiva dos recursos aplicados, compras superfaturadas ou desvio de verbas [@vasconcelos_infraestrutura_2020-1];
...
- Há uma relação negativa entre Investimentos Públicos em Educação e o Ideb, com ligeira melhora no último ano;
...
- Há um impacto positivo entre a Infraestrutura Escolar e o Desempenho Educacional: 
  ...
  - em 2019, o mesmo 1% investido em Infraestrutura converteu-se no aumento de 0,441% do Desempenho Escolar.
...
-   As análises apresentam:
    ...
    - um relação negativa entre Investimentos Públicos em Educação e o Desempenho no Ideb;
